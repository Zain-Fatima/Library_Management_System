...
<!--Buttons-->
    ...
    <form name="addbook" action="signup.jsp" method="post">
    ...
    <form name="viewBookInfo" action="viewBookInfo.jsp" method="post">
...
<form align="center" method="POST" action="updateBook" name="updateBook" >

<center><h3>UpdateBook-Form</h3></center><hr>
<fieldset>
<center><legend>Please fill in this form to update-book.</legend></center>   
  
    <table align="center" border="2">
    <tr>
      <td>BookID</td>
      <td><input type="text" name="bookid" placeholder=" which u want to update" required></center></center><br></td>
    </tr>

    <tr>
      <td>BookName</td>
      <td><input type="text" name="bookname" placeholder="updated value" required></center><br></td>
    </tr>

    <tr>
      <td>Author</td>
      <td><input type="text" name="author" placeholder="updated value" required></center><br></td>
    </tr>

    <tr>
      <td>Edition</td>
      <td><input type="text" name="edition" placeholder="updated value" required></center><br></td>
    </tr>
 
    <tr>
      <td colspan="2"><center><input type="submit" value="updatebook" required></center><br></center></td>
    </tr>
