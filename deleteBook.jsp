...
<html>
<head><title>dleteBook</title></head>
...
<form align="center" method="POST" action="deleteBook" name="deleteBook" >

<center><h3>DeleteBook-Form</h3></center><hr>
<fieldset>
<center><legend>Please fill in this form to delete-book.</legend></center>   
    ...
    <tr>
      <td colspan="2"><center><input type="submit" value="deleteBook" required></center><br></center></td>
    </tr>
