...
<html>
<head><title>issueBook</title></head>
...
<form align="center" method="POST" action="issueBook" name="issueBook" >

<center><h3>issueBook-Form</h3></center><hr>
<fieldset>
<center><legend>Please fill in this form to issue-book.</legend></center>   
    ...
    <tr>
      <td>StudentPhone#</td>
      <td><input type="text" name="studentphone" required></center><br></td>
    </tr>

    <tr>
      <td>BookID</td>
      <td><input type="text" name="bookid" required></center><br></td>
    </tr>
    <tr>
       <td>BookName</td>
    ...
    <tr>
      <td colspan="2"><center><input type="submit" value="issueBook" required></center><br></center></td>
    </tr>
