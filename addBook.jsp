...
<form align="center" method="POST" action="addBook" name="addBook" >

<center><h3>AddBook-Form</h3></center><hr>
<fieldset>
<center><legend>Please fill in this form to add-book.</legend></center>   
  
    <table align="center" border="2">
    <tr>
      <td>BookID</td>
      <td><input type="text" name="bookid" required></center></center><br></td>
    </tr>
    ...
    <tr>
      <td>Author</td>
      <td><input type="text" name="author" required></center><br></td>
    </tr>

    <tr>
      <td>Edition</td>
      <td><input type="text" name="edition" required></center><br></td>
    </tr>
 
    <tr>
      <td colspan="2"><center><input type="submit" value="addbook" required></center><br></center></td>
    </tr>
